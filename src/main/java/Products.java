public class Products {
    ...
    public static final Products imported_cheaper_bottle_of_perfume = new Products(6,"imported bottle of perfume", 27.99,false,true);
    ...
    public static final Products different_imported_box_of_chocolates = new Products(9,"imported box of chocolates", 11.25, true, true);
    ...
    public double getTaxes() {
        ...
        if(imported && exempt){
            return Math.round(RoundedImportTax* 100.00) / 100.00;
        }else if(imported){
            return Math.round((RoundedImportTax + RoundedSalesTax)* 100.00) / 100.00;
        }else if(exempt){
            return 0.00;
        }
        return Math.round(RoundedSalesTax* 100.00) / 100.00;
